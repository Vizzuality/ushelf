...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", "CHANGELOG", "Gemfile", "Gemfile.lock", "MIT-LICENSE", "README.rdoc", "Rakefile", "VERSION", "acts_as_indexed.gemspec", "lib/acts_as_indexed.rb", "lib/acts_as_indexed/configuration.rb", "lib/acts_as_indexed/search_atom.rb", "lib/acts_as_indexed/search_index.rb", "lib/will_paginate_search.rb", "rails/init.rb", "test/abstract_unit.rb", "test/acts_as_indexed_test.rb", "test/configuration_test.rb", "test/database.yml", "test/fixtures/post.rb", "test/fixtures/posts.yml", "test/schema.rb", "test/search_atom_test.rb", "test/search_index_test.rb"]
