...
Gem::Specification.new do |s|
  ...
  s.files = [".autotest", ".gitignore", "MIT-LICENSE", "README.rdoc", "Rakefile", "VERSION", "awesome_nested_set.gemspec", "init.rb", "lib/awesome_nested_set.rb", "lib/awesome_nested_set/base.rb", "lib/awesome_nested_set/depth.rb", "lib/awesome_nested_set/descendants.rb", "lib/awesome_nested_set/helper.rb", "lib/awesome_nested_set/railtie.rb", "rails/init.rb", "test/application.rb", "test/awesome_nested_set/helper_test.rb", "test/awesome_nested_set_test.rb", "test/db/database.yml", "test/db/schema.rb", "test/fixtures/categories.yml", "test/fixtures/category.rb", "test/fixtures/departments.yml", "test/fixtures/notes.yml", "test/test_helper.rb"]
